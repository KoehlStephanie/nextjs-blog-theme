...
const SubmitReview = () => {
  return (
    <div className="max-w-xl mx-auto p-6 text-gray-900 bg-white dark:bg-gray-900 dark:text-white">
      ...
      <form name="ex-review" method="POST" data-netlify="true" className="space-y-4">
        ...
        <button
          type="submit"
          className="mt-4 bg-pink-300 text-white font-bold py-2 px-6 rounded-full hover:bg-yellow-500 transition-colors shadow-md"
        >
          Submit
        </button>
      </form>
